...
layui.define(["jquery", "layer"], function (exports) {
    ...
    var cpiTheme = {
        ...
        render: function (options) {
            ...
            cpiTheme.buildThemeCss(bgcolorId);
            if (options.listen) cpiTheme.listen(options);
        },
        ...
        buildThemeCss: function (bgcolorId) {
            ...
            var bgcolorData = cpiTheme.config(bgcolorId);
        ...
        buildBgColorHtml: function (options) {
            ...
            var bgColorConfig = cpiTheme.config();
            var html = '';
        ...
        listen: function (options) {
            $('body').on('click', '[data-bgcolor]', function () {
                ...
                var bgColorHtml = cpiTheme.buildBgColorHtml(options);
